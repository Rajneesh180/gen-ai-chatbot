...
RAG chatbot that answers questions about GitLab's internal processes, values, engineering practices, and product strategy — built on their public **Handbook** and **Direction** pages.
